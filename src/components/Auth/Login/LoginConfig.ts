...
// google_login
export const GOOGLE_CLIENT_ID = process.env.NEXT_PUBLIC_GOOGLE_CLIENT_KEY
export const GOOGLE_CLIENT_PASSWORD = process.env.NEXT_PUBLIC_GOOGLE_CLIENT_PASSWORD
...
export const NAVER_REDIRECT_URL = 'http://localhost:3000/login/naver'
