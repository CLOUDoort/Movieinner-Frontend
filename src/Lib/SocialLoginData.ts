...
const KAKAO_REDIRECT_URI = 'https://www.movie-inner.click/login/kakao'
...
const GOOGLE_REDIRECT_URI = 'https://www.movie-inner.click/login/google'
...
const NAVER_REDIRECT_URL = 'https://www.movie-inner.click/login/naver'
